...
<html lang="zh-CN">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/zz3.0/Public/Css/signin.css" />
    <link rel="stylesheet" type="text/css" href="/zz3.0/Public/Css/home.css" />
    <link rel="stylesheet" type="text/css" href="/zz3.0/Public/Css/pro_con.css" />

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script type="text/javascript" src="/zz3.0/Public/Js/ie-emulation-modes-warning.js"></script>
    <script type="text/javascript" src="/zz3.0/Public/Js/jquery.min.js"></script>
    <script type="text/javascript" src="/zz3.0/Public/Js/bootstrap.min.js"></script>
  ...
  <body>
    <header style="z-index: 2;">
       <a href="/zz3.0/index.php/Home/Index/home.html"><img src="/zz3.0/Public/Images/logo.png" /><a>
       <span><img src="/zz3.0/Public/Images/zhifu.jpg"></span>
       ...
       <p style="clear:left;"><hr/></p> 
        <div id="file">
            ...
            <?php if(is_array($file)): foreach($file as $k=>$vo): ?><li class="file_name">
               ...
               <a class="glyphicon glyphicon-download-alt" href="/zz3.0/Public\Upload\<?php echo ($vo); ?>" download="<?php echo ($k); ?>" ></a>
             <!--  -->
            <!-- <a class="glyphicon glyphicon-download-alt" href="/zz3.0/index.php/Home/File/down_upload/filename/<?php echo ($k); ?>"></a> --> 
            </li>
               <p class="file_introduce"></p><?php endforeach; endif; ?>
           
           </ul>

         <!-- 上传文件 -->
          <form action="/zz3.0/index.php/Home/File/upload/number/<?php echo ($number); ?>" enctype="multipart/form-data" method="POST" id="upload">
        ...
        <div id="posts" style="display: none;position: relative;">
            <div id="left">
                ...
                <?php if(is_array($message)): foreach($message as $k=>$vo): ?><li style="height: 100px;">
                      <p>
                        <a href="/zz3.0/index.php/Home/Message/content_show/id/<?php echo ($vo["s_id"]); ?>/number/<?php echo ($number); ?>" target="_blank"><h3 style="color: #ccc;margin-left:30px; "><?php echo ($vo["s_title"]); ?></h3></a>
...
<!--                 <div id="my_message">  
                  <form  name="message" action="/zz3.0/index.php/Home/Message/getmessage/id/<?php echo ($number); ?>"  method="POST"  id="my_message_form" style=" visibility: hidden;">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form  name="message" action="/zz3.0/index.php/Home/Message/getmessage/id/<?php echo ($number); ?>"  method="POST"  id="my_message_form" >
    ...
    <script type="text/javascript" src="/zz3.0/Public/Js/ie10-viewport-bug-workaround.js"></script>
    <script type="text/javascript" src="/zz3.0/Public/Js/jquery.min.js"></script>
