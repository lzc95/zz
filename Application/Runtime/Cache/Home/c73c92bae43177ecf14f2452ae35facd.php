...
<html >
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/zz3.0/Public/Css/person_info.css" />
    ...
    <script type="text/javascript" src="/zz3.0/Public/Js/echarts.min.js"></script>
  ...
  <div id="person_info">
    ...
    <!--  <ul id="person_info_nav">
     ...
     <div id="user_info">
       <h4>个人信息</h4>
       <div class="info_pho">
         <img src="/zz3.0/Public/Images/zhifu.jpg">
       </div>
       <div class="info_con">
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                 ...
                 <form action="/zz3.0/index.php/Home/User/savepw" method="POST">
...
<!-- kaishi -->
        <?php if(is_array($team_create)): foreach($team_create as $k=>$vo): ?><li>
            <span class="pro_name"><a style="color:green" href="/zz3.0/index.php/Home/Team/pro_show/id/<?php echo ($k); ?>"><?php echo ($vo); ?></a></span>
             ...
             <!-- 以下是增添成员的页面信息 -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                 ...
                 <form action="/zz3.0/index.php/Home/Team/add_people/id/<?php echo ($k); ?>" method="POST" id="add_form">
                    <div class="modal-body">
    ...
    <div class="modal-content">
     ...
     <form  method="GET"  id="del_form">
        ...
        <div class="modal-footer">
         ...
         <div class="modal-dialog">
          <div class="modal-content">
           ...
           <form  id="del_pro_form" action="/zz3.0/index.php/Home/Team/del_team/id/<?php echo ($k); ?>">
        ...
        <?php if(is_array($team_add)): foreach($team_add as $key=>$v): ?><li>
            <span class="pro_name"><a style="color:green"  href="/zz3.0/index.php/Home/Team/pro_show/id/<?php echo ($key); ?>"><?php echo ($v); ?></a></span>
          ...
          // <!--增加成员 -->
               for(var i=0;i<aId.length;i++)
               {
                  (function(arg){
                     ...
                     {
                      aAdd_form.action="/zz3.0/index.php/Home/Team/add_people/id/"+aId[arg].innerHTML;
                     }
                  })(i)
               }
           ...
           // 删除成员
               for(var i=0;i<aId.length;i++)
               {
                  (function(arg){
                     ...
                     {
                       $.ajax({
                          url:"/zz3.0/index.php/Home/Team/people/id/"+aId[arg].innerHTML,
                          success:function(data){  
                              ...
                              aDel_form.action="/zz3.0/index.php/Home/Team/del_people/id/"+aId[arg].innerHTML;
            ...
            // 删除项目
               for(var i=0;i<aId.length;i++)
               {
                  (function(arg){
                    ...
                    {
                    aDel_pro_form.action="/zz3.0/index.php/Home/Team/del_team/id/"+aId[arg].innerHTML;
                    }
          ...
          for(var i=0;i<aItem_add_id.length;i++)
           {
              (function(arg){
                 aExit_team[i].onclick=function(){
                     $.ajax({
                      url:"/zz3.0/index.php/Home/Team/my_del/id/"+aItem_add_id[arg].innerHTML,
                      success:function(data){
                         window.location="/zz3.0/index.php/Home/Index/home";
                      }
                     })
                 }
              })(i)
