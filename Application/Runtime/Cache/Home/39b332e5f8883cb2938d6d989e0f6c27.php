...
<html >
  ...
  <body>
    <header style="z-index: 2;">
       <a href="/zz3.0/index.php/Home/Index/home"><img src="/zz3.0/Public/Images/logo.png" /><a>
    ...
    <aside>
      ...
      <ul id="nav">
        ...
        <li><a href="/zz3.0/index.php/Home/Login/outlogin"><span class="glyphicon glyphicon-off"></span>退出系统</a></li>
      </ul>
    </aside>
    <article id="content">
      <div id="pro_box">
       ...
       <?php if(is_array($team_show)): foreach($team_show as $k=>$vo): ?><div class="pro">        
               <a href="/zz3.0/index.php/Home/Team/pro_show/id/<?php echo ($k); ?>"><?php echo ($vo); ?></a>
...
<!--   我是下分割线    -->    
    ...
    <script type="text/javascript" src="/zz3.0/Public/Js/common.js"></script> 
    ...
    $(function(){
         ...
         　$('#ajax').attr("disabled",true);
           ...
           // 点击按钮后将表单信息存入数据库
           $('#ajax').click(function(){
                $.get('/zz3.0/index.php/Home/ChatInfo/setchat',{'content':content},function(jdata){
                     if(jdata){
                      $('#con').val(""); 
                     }
                }); 
 ...
 <!--  <script type="text/javascript">
    ...
    <script type="text/javascript">
      $(function(){
        // 添加一个新项目
        $('#add').click(function(){
           window.location="/zz3.0/index.php/Home/Team/add_pro";
        ...
        //          $('article').load('/zz3.0/index.php/Home/Team/add_pro?t='+Math.random());
        //      })
        //   })(i);
    ...
    <script type="text/javascript">
             ...
             $('#person_info').click(function(){
                 ...
                 $('article').load('/zz3.0/index.php/Home/Index/person_info');
             })
             $('#notify').click(function(){

                 $('article').load('/zz3.0/index.php/Home/Index/notify');
             })
        
            $('#search').click(function(){

                   $('article').load('/zz3.0/index.php/Home/Index/search');
            })
    </script>
