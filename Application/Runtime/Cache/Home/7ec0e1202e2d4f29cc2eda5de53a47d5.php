...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/zz3.0/Public/Css/content.css" />
...
<body>
  ...
  <div class="big">
      <div class="content">
        <div class="left"> 
           <div class="intro">
         	<img src="/zz3.0/Public/Images/image.jpg"style="margin:5px;" alt="文字说明">
         ...
         <?php if(is_array($message)): foreach($message as $key=>$vo): ?><div class="cont1">
          ...
          <?php if(is_array($reply)): foreach($reply as $k=>$vo): ?><div class="response">
           ...
           <div id="box">
               ...
               <form action="/zz3.0/index.php/Home/Message/response/id/<?php echo ($id); ?>/number/<?php echo ($number); ?>" name="response" method="POST">
     ...
     <!-- Modal -->
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              ...
              <!--  举报 --> 
                 <form action="/zz3.0/index.php/Home/Super/report/id/<?php echo ($id); ?>" method="POST">
