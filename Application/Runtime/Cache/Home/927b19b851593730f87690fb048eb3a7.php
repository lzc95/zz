...
<html lang="zh-CN">
  <head>
    ...
    <script type="text/javascript" src="/zz3.0/Public/Js/ie-emulation-modes-warning.js"></script></script>
  ...
  <body>
    ...
    <div class="container" >
      ...
      <form name="myform" action="/zz3.0/index.php/Home/Registered/reg_succ" method="POST" class="form-signin">
          ...
          <img id="img" src="/zz3.0/index.php/Home/Code/index" onclick='this.src=this.src+"?"+Math.random()'/>
          <button id="button" class="btn btn-lg btn-primary btn-block">注册</button>
          <a href="/zz3.0/index.php/Home/Login/login" class="noReg">已有账号？马上去登录-></a>
      </form>
    ...
    <script type="text/javascript"> 
       $(function(){
           ...
           $('#u_email').blur(function(){                 //绑定失去焦点方法
               ...
               $.get('/zz3.0/index.php/Home/Registered/checkName',{'username':username},function(jdata){  
                   if(jdata.status!=0){
                      error['info']=0;
